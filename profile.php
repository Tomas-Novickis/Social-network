...
<div class="row">
    ...
    <div class="col-sm-8">
        <?php
         ...
         echo "
                ...
                <ul class='nav pull-left' style='position:absolute; top:10px; left:40px;'>
                  <li class='dropdown'>
                    ...
                    <div class='dropdown-menu'>
                      ...
                      <button name='submit' class='btn btn-info'>Update cover</button></center>
            ...
            <div id='profile-img'>
                <img src='users/$user_image' alt='Profile' class='img-circle' width='180px'
                height='185px'>
                <form action='profile.php?u_id='$user_id' method='post'
                enctype='multipart/form-data'>

                <label id='update_profile'>Change picture
                <input type='file' name='u_image' size='60' />
                </label><br><br>
                <button id='button_profile' name='update' class='btn btn-info'>Update profile picture</button></center>
        ...
        <?php
          if(isset($_POST['submit'])){
              ...
              $random_number = rand(1,100);
               if($u_cover==''){
                    echo "<script>alert('Pleasse select cover image')</script>";
    ...
    <?php
          if(isset($_POST['update'])){
              ...
              $random_number = rand(1,100);
               if($u_image==''){
                    echo "<script>alert('Pleasse select profile image')</script>";
                    echo "<script>window.open('profile.php?u_id=$user_id', '_self')</script>";
                    exit();
